  ...
  <div class="flex flex-col items-center gap-8">
    ...
    <div class="flex gap-4">
      <Button
        ...
        size="lg"
        class="gap-2 px-8 py-6 text-lg font-bold bg-sky-400 hover:bg-sky-500 text-white transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
      >
