    ...
    <div class="flex items-center justify-between py-3 px-6">
      ...
      <div class="hidden lg:flex items-center space-x-6">
        ...
        <router-link
          to="/planner"
          class="flex items-center gap-1 font-medium hover:text-blue-600 transition-colors"
          :class="{ 'text-blue-600 border-b-2 border-blue-600': isActive('/planner') }"
        >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
        ...
        <template v-else>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" class="w-44">
              ...
              <DropdownMenuItem @click="router.push('/saved')" class="cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                  <path fill-rule="evenodd" d="M6.32 2.577a49.255 49.255 0 0 1 11.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 0 1-1.085.67L12 18.089l-7.165 3.583A.75.75 0 0 1 3.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93Z" clip-rule="evenodd" />
                </svg>
                Saved
              </DropdownMenuItem>
              <DropdownMenuItem @click="router.push('/friends')" class="cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
      ...
      <button
        ...
        class="lg:hidden flex flex-col justify-center items-center space-y-1.5 focus:outline-none"
      >
