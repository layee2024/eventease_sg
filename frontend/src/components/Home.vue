...
<template>
  <main class="container-fluid px-4 py-4">
    ...
    <div class="text-center mb-5">
      <h1 class="display-6 fw-bold mb-4">Discover Amazing Events in Singapore</h1>
      <p class="fs-5 text-muted mx-auto mb-4" style="max-width: 48rem">
    ...
    <div class="row g-4">
      ...
      <!-- Tabs -->
      <div class="mb-4">
            <ul class="nav nav-tabs nav-justified max-w-50">
              <li class="nav-item">
                <button 
